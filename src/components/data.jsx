...
function FetchApi() {
  ...
  return (
    <section className="top-products">
      <div className="w-[1400px] mx-auto px-4 py-5ner">
        <div>
          {data ? (
            <ul className="top-products__list">
              {data.map((user) => (
                <li
                  className="text-white top-products__item"
                  key={user.id}
                  title={user.name}
                >
                  <button
                    title={user.name + "ni sevimlilarga qo'shish"}
                    id="favorite-btn"
                    class="top-products__likebtn"
                  >
                    <div class="top-products__ripple"></div>
                    <svg
                      data-v-56571d0e=""
                      width="20"
                      height="20"
                  ...
                  <div class="top-products__imagebox">
                    <img
                  ...
                  <div class="top-products__box">
                    <p class="top-products__name">{user.name}</p>
                    <p class="top-products__rating">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="15"
                        height="15"
                      ...
                      <span>5.0 (67 baho)</span>
                    </p>
                    <p class="top-products__monthly">
                      <mark>
                        <span>{Math.floor((user.price * 360) / 30)}</span>
                        so'm/oyiga
                      </mark>
                    </p>
                    <div class="top-products__bottom">
                      <div class="top-products__prices">
                        <p class="top-products__subprice">
                          {user.price * 130} so'm
                        </p>
                        <p class="top-products__price">
                          {user.price * 100} so'm
                        </p>
                      </div>
                      <button
                        title={user.name + "ni savatga qo'shish"}
                        id="button-basket"
                        class="top-products__btnbasket"
                      >
                        <svg
                          data-v-56571d0e=""
                          width="24"
                  ...
                  <div class="top-products__height"></div>
                </li>
              ))}
            </ul>
          ) : (
